    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Helium Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Helium Core"));
...
All the Helium in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 HELIUM, 0.1 HELIUM, 1 HELIUM and 10 HELIUM -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://heliumpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://heliumpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Helium Core is shutting down...") + "<br /><br />" +
