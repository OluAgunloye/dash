 ...
 *
 *   // network
 *   CHeliumNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.helium.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CHeliumNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: HeliumNetwork
// //   -- signature requirements : Key1(User)
// class CHeliumNetworkVariable : public CGovernanceObject
// {
// private:
