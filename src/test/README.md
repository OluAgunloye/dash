...
unit testing framework, and since Helium Core already uses boost, it makes
...
... or to run just the doublehelium test:

    test_helium --run_test=getarg_tests/doublehelium
