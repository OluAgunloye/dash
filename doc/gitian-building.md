...
*Setup instructions for a Gitian build of Helium Core using a Debian VM or physical system.*
...
- [Building Helium Core](#building-helium-core)
...
Clone the git repositories for Helium Core and Gitian.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/heliumpay/helium
```
...
in the Helium Core repository under 'Fetch and build inputs' to install sources which require
...
Gitian builds' in [doc/release-process.md](release-process.md#perform-gitian-builds) in the Helium Core repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/helium/.git/
    remote: Counting objects: 57959, done.
    remote: Total 57959 (delta 0), reused 0 (delta 0), pack-reused 57958
    Receiving objects: 100% (57959/57959), 53.76 MiB | 484.00 KiB/s, done.
    Resolving deltas: 100% (41590/41590), done.
    From https://github.com/heliumpay/helium
...
For example:
```bash
URL=https://github.com/crowning-/helium.git
...
BTCPATH=/some/root/path/helium.git
SIGPATH=/some/root/path/helium-detached-sigs.git
...
```bash
    ...
    gpg --detach-sign ${VERSION}-win/${SIGNER}/helium-win-build.assert
...
[helium/gitian.sigs](https://github.com/heliumpay/gitian.sigs/) repository, or if that's not possible to create a pull
request.
