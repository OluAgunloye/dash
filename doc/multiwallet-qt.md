...
Only requiring some minor changes is helium.cpp.
...
Changes to helium.cpp
----------------------
helium.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
